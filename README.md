[![Build status](https://ci.appveyor.com/api/projects/status/407nrbdj04u74wep?svg=true)](https://ci.appveyor.com/project/Rail-G/react-sage-observable-front)
...
1. [Поиск](./src/tsx/search).
1. [Список и подробности](./src/tsx/mainDetails).
